"""
Django settings for testrouterocket_46112 project.
...
ROOT_URLCONF = 'testrouterocket_46112.urls'
...
WSGI_APPLICATION = 'testrouterocket_46112.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testrouterocket_46112 API",
    "DESCRIPTION": "API documentation for testrouterocket_46112 App",
    "VERSION": "v1",
}
